...
with open('atikutweets'+date+'.csv', mode='w', encoding='utf-8') as csvFile:
    #Use csv Writer
    csvWriter = csv.writer(csvFile,lineterminator = '\n')

    csvWriter.writerow(['Date', 'Text', 'Username', 'Location'])
    for tweet in tweepy.Cursor(api.search,q="atiku -@atiku -buhari",
                               lang="en", count=50, tweet_mode='extended', since='2019-01-07').items():
